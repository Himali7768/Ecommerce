...
public class delete {
	...
	public static void deleteUserDetails() throws SQLException, ClassNotFoundException
	{
	...
	public static void deleteProductDetails() throws ClassNotFoundException, SQLException
	{
		//delete product data
		Db_Connection db_Connection=new Db_Connection();
		Connection con=db_Connection.getConnection();
